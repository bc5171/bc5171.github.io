...
export const HEROES: Hero[] = [
    ...
    { id: 2, name: 'Axe', rank: 4.5 },
    { id: 3, name: 'Bristleback', rank: 3.5 },
    { id: 4, name: 'Centaur Warrunner', rank: 2 },
    ...
    { id: 10, name: 'Earthshaker', rank: 1.5 },
    { id: 11, name: 'Elder Titan', rank: 1.5 },
    { id: 12, name: 'Huskar', rank: 3 },
    ...
    { id: 87, name: 'Silencer', rank: 4.5 },
    { id: 88, name: 'Skywrath Mage', rank: 3 },
    { id: 89, name: 'Storm Spirit', rank: 1 },
    { id: 90, name: 'Tinker', rank: 1 },
    { id: 91, name: 'Warlock', rank: 2.5 },
    { id: 92, name: 'Witch Doctor', rank: 2.5 },
    { id: 93, name: 'Zeus', rank: 1 },
